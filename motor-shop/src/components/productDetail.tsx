    ...
    <>
      <div className='flex flex-col gap-3' >
        ...
        <div className='bg-grey-10 mt-4 rounded py-7 px-11' >
          ...
          <p className='body-1-400'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
