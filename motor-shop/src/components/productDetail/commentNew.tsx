        ...
        token !== undefined ? (
          ...
          <div className="py-9 px-11 bg-slate-100 rounded-[4px] bg-grey-whiteFixed">
            <form className="relative">
              ...
              <button
                disabled
                className="btn-medium bg-brand-1 text-grey-whiteFixed rounded p-5 font-semibold absolute bottom-5 right-4 transition ease-in-out delay-300 hover:bg-brand-2"
              >
                Comentar
              </button>
            </form>
